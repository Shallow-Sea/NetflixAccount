...
// 处理管理员添加（仅限管理员）
if ($_POST['action'] ?? '' === 'add_admin' && isAdmin()) {
...
if (!isAdmin()) {
    ...
    $stmt = $pdo->prepare("
        SELECT 
            ...
            COUNT(CASE WHEN sp.is_activated = 1 THEN 1 END) as activated_shares,
            COUNT(CASE WHEN sp.is_activated = 1 AND sp.expires_at > NOW() THEN 1 END) as active_shares
        FROM share_pages sp 
        WHERE sp.user_id = ?
    ");
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9"><?php echo $user['email'] ? htmlspecialchars($user['email']) : '未设置'; ?></div>
                        </div>
                        <hr>
                        <div class="row">
                            <div class="col-sm-3"><strong>手机:</strong></div>
                            <div class="col-sm-9"><?php echo $user['phone'] ? htmlspecialchars($user['phone']) : '未设置'; ?></div>
                        </div>
                        <hr>
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <span class="badge bg-<?php echo $user['status'] === 'active' ? 'success' : 'warning'; ?>">
                                    <?php echo $user['status'] === 'active' ? '正常' : '未激活'; ?>
                                </span>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="row text-center">
                            <div class="col-md-4">
                                <div class="card border-primary">
                                    <div class="card-body">
                                        <h4 class="text-primary"><?php echo $stats['total_shares']; ?></h4>
                                        <p class="card-text">总分享页数</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="card border-success">
                                    <div class="card-body">
                                        <h4 class="text-success"><?php echo $stats['activated_shares']; ?></h4>
                            ...
                            <div class="col-md-4">
                                <div class="card border-warning">
                                    <div class="card-body">
                                        <h4 class="text-warning"><?php echo $stats['active_shares']; ?></h4>
                                        <p class="card-text">使用中</p>
                                    </div>
                                </div>
                            </div>
                        </div>
